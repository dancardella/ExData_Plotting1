...
with(days_we_want, {
  ...
  plot(Time, Voltage/8, ylab = "Voltage")

  plot(Time, Sub_metering_1, type ="n", xaxp= c(0,40,10), mar =c(1,1,1,1), ylab = "Submetering")
  ...
  plot(Time, Global_reactive_power, ylab = "Global Reactive Power(kilowatts)")
})
